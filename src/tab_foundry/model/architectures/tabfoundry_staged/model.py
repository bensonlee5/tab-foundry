...
class TabFoundryStagedClassifier(nn.Module):
    ...
    def __init__(
        self,
        *,
        stage: str | None = _D["stage"],
        stage_label: str | None = _D["stage_label"],
        module_overrides: dict[str, object] | None = _D["module_overrides"],
        d_col: int = _D["d_col"],
        d_icl: int = _D["d_icl"],
        ...
        staged_dropout: float = _D["staged_dropout"],
