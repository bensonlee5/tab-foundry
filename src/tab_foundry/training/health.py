...
def _comparison_summary_excerpt(summary: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "best_bpc": _summary_value(tab_foundry, "best_bpc"),
        "final_bpc": _summary_value(tab_foundry, "final_bpc"),
        "best_bpf": _summary_value(tab_foundry, "best_bpf"),
        "final_bpf": _summary_value(tab_foundry, "final_bpf"),
