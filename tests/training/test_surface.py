        ...
        [
            {
                ...
                "catalog_path": "dataset_catalog.parquet",
                "catalog_dataset_index": 1,
            ...
            },
            {
                ...
                "test_path": "test.parquet",
                "catalog_path": "dataset_catalog.parquet",
                "catalog_dataset_index": 2,
                "catalog_record_sha256": "1" * 64,
                "n_train": 30,
                "n_test": 10,
                "n_features": 8,
                "n_classes": 2,
...
def test_build_training_surface_record_includes_grid_pre_mixer_depth_metadata(
    ...
    assert record["model"]["architecture"]["grid_residual_mode"] == "prenorm"
