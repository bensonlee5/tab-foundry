...
- Prefer breaking dependency cycles and centralizing shared wiring in `src/tab_foundry/core`; avoid "legacy" pathways, duplicate pathways, and shims. Do not introduce parallel implementations of the same logic in different layers of the codebase.
