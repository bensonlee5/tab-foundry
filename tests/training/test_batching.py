...
def _write_manifest_dataset(
    ...
    *,
    ...
    catalog_metadata = _write_packed_shard(shard_dir, datasets=resolved_datasets)
            ...
            [
                {
                    ...
                    "catalog_offset_bytes": _catalog_offset,
                    "catalog_size_bytes": _catalog_size,
                ...
                for _catalog_offset, _catalog_size, digest in [
                    catalog_metadata[int(dataset["dataset_index"])]
                ]
            ]
        ),
        manifest_path,
