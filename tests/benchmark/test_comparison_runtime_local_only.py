...
def test_run_nanotabpfn_benchmark_suppresses_posthoc_wandb_for_reused_artifacts(
    monkeypatch,
    tmp_path: Path,
) -> None:
    run_dir = tmp_path / "run"
    ...
    monkeypatch.setattr(
        ...
        lambda **_kwargs: (_ for _ in ()).throw(
            AssertionError("reused-artifact benchmark should skip posthoc wandb sync")
        ),
    )
