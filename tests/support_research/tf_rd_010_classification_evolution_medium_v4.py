...
EXPECTED_ROW_STATUSES = ["completed", "ready", "ready", "ready"]
EXPECTED_RUN_IDS = [ANCHOR_RUN_ID, None, None, None]
EXPECTED_DECISIONS = ["keep", None, None, None]
EXPECTED_INTERPRETATION_STATUSES = ["completed", "pending", "pending", "pending"]
