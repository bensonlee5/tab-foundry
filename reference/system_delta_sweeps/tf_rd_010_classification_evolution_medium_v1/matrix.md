...
`reference/system_delta_sweeps/tf_rd_010_classification_evolution_medium_v1/queue.yaml`
after invalidating the previously recorded medium executions as canonical
evidence.
...
- Anchor run id: `null`
- Benchmark manifest: legacy local benchmark id `nanotabpfn_openml_classification_medium_v1`, materialized from upstream bundle `openml_classification_medium_v1.json`
