...
- Required work:
  ...
  - Phase 2: bounded width or readout-capacity follow-up
    - use [#183](https://github.com/bensonlee5/tab-foundry/issues/183) for the
      immediate `d_icl` and `head_hidden_dim` follow-up after the completed
      sandwich knob screen kept the compact control unchanged
