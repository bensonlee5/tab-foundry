...
- The active medium path under [#205](https://github.com/bensonlee5/tab-foundry/issues/205)
  is now the `tf_rd_010_classification_evolution_medium_v4` full rerun under
  the `task_batch_size=16`, `grad_accum_steps=4` contract. The preserved
  `medium_v3` package is historical no-clipping evidence
  only after rows 1-3 hit very early best benchmark steps and then drifted
