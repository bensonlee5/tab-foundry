...
This file is rendered from `reference/system_delta_sweeps/tf_rd_009_ns_upper_extension_one_epoch_medium_v1/resolved_queue.yaml` (derived from `reference/system_delta_sweeps/tf_rd_009_ns_upper_extension_one_epoch_medium_v1/queue.yaml` plus `reference/system_delta_catalog.yaml`) and the canonical benchmark registry.

## Sweep

- Sweep id: `tf_rd_009_ns_upper_extension_one_epoch_medium_v1`
- Sweep status: `draft`
- Parent sweep id: `tf_rd_009_width_depth_upper_extension_one_epoch_medium_v1`
- Complexity level: `classification_md`
- Resolved queue path: `reference/system_delta_sweeps/tf_rd_009_ns_upper_extension_one_epoch_medium_v1/resolved_queue.yaml`
- Resolved queue inputs fingerprint: `9efea814e7a1bc8136035037a1659011589dd40c663622386537695a7562ea6e`
