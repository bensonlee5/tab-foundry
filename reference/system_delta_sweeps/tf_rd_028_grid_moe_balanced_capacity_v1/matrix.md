...
- Resolved queue inputs fingerprint: `82e646c28a80ae2fb13f9e9dc35edf2096dd307c2edfe88bfc55595f369b8ce7`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `delta_tf_rd_028_grid_moe_e4_top1_smoke_v1` | grid_sandwich_moe_balanced_capacity | no | completed | none | Run a short benchmark-capable smoke of the TF-RD-026 row 10 Grid-Sandwich anchor with core-only SwiGLU MoE FFNs using four experts and top-1 routing. | Execute first on the Vast VM and unblock the full MoE ladder only after smoke training, benchmark artifacts, and W&B logging are clean. |
| 2 | `delta_tf_rd_028_grid_moe_e2_top1_v1` | grid_sandwich_moe_balanced_capacity | no | completed | none | Test the TF-RD-026 row 10 Grid-Sandwich anchor with core-only SwiGLU MoE FFNs using two experts and top-1 routing. | Execute as the first full-budget TF-RD-028 top-1 MoE candidate after the smoke row passes. |
| 3 | `delta_tf_rd_028_grid_moe_e4_top1_v1` | grid_sandwich_moe_balanced_capacity | no | completed | none | Test the TF-RD-026 row 10 Grid-Sandwich anchor with core-only SwiGLU MoE FFNs using four experts and top-1 routing. | Execute as the main TF-RD-028 top-1 MoE candidate after the smoke row passes. |
| 4 | `delta_tf_rd_028_grid_moe_e8_top1_v1` | grid_sandwich_moe_balanced_capacity | no | completed | none | Test the TF-RD-026 row 10 Grid-Sandwich anchor with core-only SwiGLU MoE FFNs using eight experts and top-1 routing. | Execute after E=2 and E=4 top-1 rows show finite losses and usable route-health metrics. |
| 5 | `delta_tf_rd_028_grid_moe_e4_top2_v1` | grid_sandwich_moe_balanced_capacity | no | failed | none | Test the TF-RD-026 row 10 Grid-Sandwich anchor with core-only SwiGLU MoE FFNs using four experts and top-2 routing. | Execute only after the top-1 MoE rows pass route-health inspection and quality is not explained by a routing bug. |
| 6 | `delta_tf_rd_028_grid_moe_e4_top2_microbatch8_v1` | grid_sandwich_moe_balanced_capacity | no | completed | none | Test the TF-RD-026 row 10 Grid-Sandwich anchor with core-only SwiGLU MoE FFNs using four experts and top-2 routing under a smaller task microbatch so the min-2-expert path fits on the current L40S VM. | Execute after the uncheckpointed top-2 row OOMs and the top-1 rows show finite, non-collapsed route-health metrics. |
...
- Stage-local stability: row (grad `0.1179`)
...
- Decision: `defer`
- Notes:
  - Canonical rerun registered as `sd_tf_rd_028_grid_moe_balanced_capacity_v1_01_delta_tf_rd_028_grid_moe_e4_top1_smoke_v1_v4`.
...
- Registered run: `sd_tf_rd_028_grid_moe_balanced_capacity_v1_01_delta_tf_rd_028_grid_moe_e4_top1_smoke_v1_v4` with final log loss `0.7274`, delta final log loss `+0.3092`, final Brier score `0.4536`, delta final brier score `+0.1984`, final ROC AUC `0.6233`, delta final roc auc `-0.1899`, best ROC AUC `0.6233`, delta final training time `-3337.0s`
...
- Stage-local stability: row (grad `0.0473`)
...
- Decision: `defer`
- Notes:
  - Canonical rerun registered as `sd_tf_rd_028_grid_moe_balanced_capacity_v1_02_delta_tf_rd_028_grid_moe_e2_top1_v1_v1`.
  - Canonical benchmark comparison recorded against the locked sweep anchor; interpret this row in the full sweep context.
- Follow-up run ids: `[]`
...
- Registered run: `sd_tf_rd_028_grid_moe_balanced_capacity_v1_02_delta_tf_rd_028_grid_moe_e2_top1_v1_v1` with final log loss `0.4229`, delta final log loss `+0.0047`, final Brier score `0.2575`, delta final brier score `+0.0024`, final ROC AUC `0.8103`, delta final roc auc `-0.0029`, best ROC AUC `0.8103`, delta final training time `+1431.2s`
...
- Resolved runtime surface: `{'seed': 1, 'mixed_precision': 'bf16', 'num_workers': 'auto', 'loader_pin_memory': True, 'loader_train_shuffle': True, 'loader_persistent_workers': False, 'loader_prefetch_factor': 'auto', 'loader_task_batch_cache': False, 'loader_task_batch_cache_mode': 'bounded_streaming', 'non_blocking_device_transfer': True, 'grad_clip': 0.0, 'grad_accum_steps': 4, 'compile_model': True, 'compile_dynamic': True, 'compile_backend': 'eager', 'compile_mode': 'max-autotune-no-cudagraphs', 'compile_shape_dispatch_mode': 'signature_family', 'compile_shape_dispatch_max_families': 16, 'trace_activations': False, 'signature_family_run_length': 4, 'module_grad_norm_every': 1, 'profile_step_timing': False, 'activation_checkpointing': False, 'eval_every': 25, 'checkpoint_every': None, 'val_batches': 0, 'max_steps': 5000, 'signature_family_optimizer_step_block_length': 4}`
- Stage-local stability: row (grad `0.0488`)
- Model overrides: `{'grid_moe_scope': 'grid_core_ffn', 'grid_moe_num_experts': 4, 'grid_moe_top_k': 1, 'grid_moe_router_init_std': 0.01}`
- Parameter adequacy plan:
  - Execute after the diagnostic smoke row passes.
  - Compare directly against the locked TF-RD-026 row 10 anchor by final_log_loss_at_matched_regime_budget and route-health telemetry.
...
- Decision: `defer`
- Notes:
  - Canonical rerun registered as `sd_tf_rd_028_grid_moe_balanced_capacity_v1_03_delta_tf_rd_028_grid_moe_e4_top1_v1_v1`.
  - Canonical benchmark comparison recorded against the locked sweep anchor; interpret this row in the full sweep context.
- Follow-up run ids: `[]`
...
- Registered run: `sd_tf_rd_028_grid_moe_balanced_capacity_v1_03_delta_tf_rd_028_grid_moe_e4_top1_v1_v1` with final log loss `0.4222`, delta final log loss `+0.0040`, final Brier score `0.2569`, delta final brier score `+0.0018`, final ROC AUC `0.8109`, delta final roc auc `-0.0024`, best ROC AUC `0.8109`, delta final training time `+2394.7s`
...
- Resolved runtime surface: `{'seed': 1, 'mixed_precision': 'bf16', 'num_workers': 'auto', 'loader_pin_memory': True, 'loader_train_shuffle': True, 'loader_persistent_workers': False, 'loader_prefetch_factor': 'auto', 'loader_task_batch_cache': False, 'loader_task_batch_cache_mode': 'bounded_streaming', 'non_blocking_device_transfer': True, 'grad_clip': 0.0, 'grad_accum_steps': 4, 'compile_model': True, 'compile_dynamic': True, 'compile_backend': 'eager', 'compile_mode': 'max-autotune-no-cudagraphs', 'compile_shape_dispatch_mode': 'signature_family', 'compile_shape_dispatch_max_families': 16, 'trace_activations': False, 'signature_family_run_length': 4, 'module_grad_norm_every': 1, 'profile_step_timing': False, 'activation_checkpointing': False, 'eval_every': 25, 'checkpoint_every': None, 'val_batches': 0, 'max_steps': 5000, 'signature_family_optimizer_step_block_length': 4}`
- Stage-local stability: row (grad `0.0483`)
...
- Decision: `defer`
- Notes:
  - Canonical rerun registered as `sd_tf_rd_028_grid_moe_balanced_capacity_v1_04_delta_tf_rd_028_grid_moe_e8_top1_v1_v1`.
  - Canonical benchmark comparison recorded against the locked sweep anchor; interpret this row in the full sweep context.
- Follow-up run ids: `[]`
...
- Registered run: `sd_tf_rd_028_grid_moe_balanced_capacity_v1_04_delta_tf_rd_028_grid_moe_e8_top1_v1_v1` with final log loss `0.4220`, delta final log loss `+0.0038`, final Brier score `0.2573`, delta final brier score `+0.0022`, final ROC AUC `0.8123`, delta final roc auc `-0.0009`, best ROC AUC `0.8123`, delta final training time `+4592.8s`
...
- Decision: `None`
- Notes:
  - Execution attempt `sd_tf_rd_028_grid_moe_balanced_capacity_v1_05_delta_tf_rd_028_grid_moe_e4_top2_v1_v1` failed: CUDA out of memory. Tried to allocate 180.00 MiB. GPU 0 has a total capacity of 44.39 GiB of which 131.38 MiB is free. Process 2156433 has 44.24 GiB memory in use. Of the allocated memory 43.55 GiB is allocated by PyTorch, and 200.59 MiB...
- Follow-up run ids: `[]`
...
- Decision: `defer`
- Notes:
  - Canonical rerun registered as `sd_tf_rd_028_grid_moe_balanced_capacity_v1_06_delta_tf_rd_028_grid_moe_e4_top2_microbatch8_v1_v1`.
  - Canonical benchmark comparison recorded against the locked sweep anchor; interpret this row in the full sweep context.
- Follow-up run ids: `[]`
...
- Registered run: `sd_tf_rd_028_grid_moe_balanced_capacity_v1_06_delta_tf_rd_028_grid_moe_e4_top2_microbatch8_v1_v1` with final log loss `0.4234`, delta final log loss `+0.0053`, final Brier score `0.2578`, delta final brier score `+0.0027`, final ROC AUC `0.8096`, delta final roc auc `-0.0037`, best ROC AUC `0.8096`, delta final training time `+5767.9s`
