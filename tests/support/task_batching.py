...
def write_task_batch_manifest_from_specs(
    ...
    *,
    ...
    catalog_metadata = _write_packed_shard(shard_dir, datasets=datasets)
    manifest_rows: list[dict[str, object]] = []
    for dataset in datasets:
        dataset_index = int(dataset["dataset_index"])
        catalog_offset, catalog_size, digest = catalog_metadata[dataset_index]
        manifest_rows.append(
            {
                ...
                "catalog_offset_bytes": catalog_offset,
